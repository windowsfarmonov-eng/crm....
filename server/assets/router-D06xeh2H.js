...
const appCss = "/assets/styles-BTgE4EHe.css";
const _jsxFileName = "";
function NotFoundComponent() {
  return jsxDevRuntimeExports.jsxDEV("div", {
    className: "flex min-h-screen items-center justify-center bg-background px-4",
    children: jsxDevRuntimeExports.jsxDEV("div", { className: "max-w-md text-center", children: [
      jsxDevRuntimeExports.jsxDEV("h1", { className: "text-7xl font-bold text-foreground", children: "404" }, void 0, false, { fileName: _jsxFileName, lineNumber: 17 }, this),
      jsxDevRuntimeExports.jsxDEV("h2", { className: "mt-4 text-xl font-semibold text-foreground", children: "Page not found" }, void 0, false, { fileName: _jsxFileName, lineNumber: 18 }, this),
      jsxDevRuntimeExports.jsxDEV("p", {
        className: "mt-2 text-sm text-muted-foreground",
        children: "The page you're looking for doesn't exist or has been moved."
      }, void 0, false, { fileName: _jsxFileName, lineNumber: 19 }, this),
      jsxDevRuntimeExports.jsxDEV("div", {
        className: "mt-6",
        children: jsxDevRuntimeExports.jsxDEV(Link, {
          to: "/",
...
function ErrorComponent({ error, reset }) {
  ...
  return jsxDevRuntimeExports.jsxDEV("div", {
    className: "flex min-h-screen items-center justify-center bg-background px-4",
    children: jsxDevRuntimeExports.jsxDEV("div", { className: "max-w-md text-center", children: [
      jsxDevRuntimeExports.jsxDEV("h1", {
      ...
      jsxDevRuntimeExports.jsxDEV("div", { className: "mt-6 flex flex-wrap justify-center gap-2", children: [
        jsxDevRuntimeExports.jsxDEV("button", {
          onClick: () => {
            router2.invalidate();
            reset();
          },
...
function RootShell({ children }) {
  return jsxDevRuntimeExports.jsxDEV("html", { lang: "en", children: [
    jsxDevRuntimeExports.jsxDEV("head", {
      children: jsxDevRuntimeExports.jsxDEV(HeadContent, {}, void 0, false, { fileName: _jsxFileName, lineNumber: 101 }, this)
    }, void 0, false, { fileName: _jsxFileName, lineNumber: 100 }, this),
    jsxDevRuntimeExports.jsxDEV("body", { children: [
      children,
      jsxDevRuntimeExports.jsxDEV(Scripts, {}, void 0, false, { fileName: _jsxFileName, lineNumber: 105 }, this)
    ] }, void 0, true, { fileName: _jsxFileName, lineNumber: 103 }, this)
  ] }, void 0, true, { fileName: _jsxFileName, lineNumber: 99 }, this);
}
function RootComponent() {
  const { queryClient } = Route$3.useRouteContext();
  return jsxDevRuntimeExports.jsxDEV(QueryClientProvider, {
    client: queryClient,
    children: jsxDevRuntimeExports.jsxDEV(Outlet, {}, void 0, false, { fileName: _jsxFileName, lineNumber: 116 }, this)
  }, void 0, false, { fileName: _jsxFileName, lineNumber: 115 }, this);
}
const $$splitComponentImporter = () => import("./index-Cl4nPFnm.js");
const Route$2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "EduManage o'quv markaz boshqaruv tizimi"
    }],
    links: [{
      rel: "stylesheet",
      href: "/edu-styles.css"
...
const Route$1 = createFileRoute("/api/send-attendance")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        const time = (/* @__PURE__ */ new Date()).toLocaleTimeString("uz-UZ", {
          hour: "2-digit",
          minute: "2-digit"
        });
...
const Route2 = createFileRoute("/api/ai-chat")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        let body;
...
const ApiSendAttendanceRoute = Route$1.update({
  id: "/api/send-attendance",
  path: "/api/send-attendance",
  getParentRoute: () => Route$3
});
const ApiAiChatRoute = Route2.update({
  id: "/api/ai-chat",
  path: "/api/ai-chat",
  getParentRoute: () => Route$3
});
