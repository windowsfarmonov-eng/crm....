...
(({ className, children, ...props }, ref) => (
 ...
 children: [
    children
    , _jsxDEV(NavigationMenuViewport, {}, void 0, false, {fileName: _jsxFileName, lineNumber: 18}, this )
...
(({ className, children, ...props }, ref) => (
 ...
 children: [
    ...
    , _jsxDEV(ChevronDown, {
      ...
      'aria-hidden': "true",}, void 0, false, {fileName: _jsxFileName, lineNumber: 51}, this
    )
...
(({ className, ...props }, ref) => (
  _jsxDEV('div', { className: cn("absolute left-0 top-full flex justify-center"), children: 
...
(({ className, ...props }, ref) => (
  _jsxDEV(NavigationMenuPrimitive.Indicator, {
    ...
    ...props,
 children: 
    _jsxDEV('div', { className: "relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-border shadow-md"       ,}, void 0, false, {fileName: _jsxFileName, lineNumber: 105}, this )
